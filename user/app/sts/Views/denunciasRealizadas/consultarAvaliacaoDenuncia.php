        ...
        <ul class="list-unstyled">
            ...
            <li>
                ...
                <ul class="list-unstyled collapse" id="submenu2">
                    <li><a href="<?php echo URL . 'user/consultar-dados-cadastrais/consultar-dados-cadastrais'; ?>"> <i class="fas fa-seedling text-warning"></i> Visualizar</a></li>  
...
<!--                <a href="<?php echo URL . 'user/visualizar-dados-denuncia/visualizar-dados-denuncia/' . $id ?>">
                ...
                <h5 class="estilo-font p-1 text-body" style="letter-spacing: 0.5px;"><i class="fas fa-seedling text-success"></i> <b>CONSULTAR AVALIAÇÃO</b></h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="p-2" class="form" method="POST" id="formDenunciaComum" enctype="multipart/form-data"> <!-- Final Formulário Visualizar Dados da Denúncia Comum -->
                                ...
                                <h5 class="p-2 margem-titulo borda-conteudo" id="">Dados - Avaliação da Denúncia</h5><p><p>
                                ...
                                <div class="form-group row alinhamento c-tipo-resp">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control tamanho-font bg-white" name="id" type="text" id="created" placeholder="<?php echo $id; ?>"
                                               value="<?php
                                ...
                                <div class="form-group row alinhamento c-tipo-resp">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control tamanho-font bg-white" name="status" type="text" id="modified" placeholder="<?php echo $nome_status; ?>"
                                               value="<?php
                                ...
                                <div class="form-group row alinhamento c-tipo-resp">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control tamanho-font bg-white" name="descricao" type="text" id="modified" placeholder="<?php echo $descricao_status; ?>"
                                               value="<?php
                                ...
                                <div class="form-group row alinhamento c-descricao-resp"> 
                                    <label for="ParecerTecnico" class="col-sm-2 col-form-label tamanho-font alinhar">Parecer Técnico&nbsp;</label> 
                                    <div class="col-sm-9">
                                        <textarea readonly class="form-control tamanho-font tamanho-descricao bg-white" name="parecerTecnico" type="text" id="parecerTecnico" placeholder="<?php echo $parecer_tecnico;?>"><?php
