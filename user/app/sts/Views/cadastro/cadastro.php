                ...
                <div class="col-md-12">
                    ...
                    <form class="p-2" method="POST" action=""> <!-- Início Formulário Cadastro -->
                        ...
                        <div class="form-group row alinhamento c-telefone-resp"> 
                            <label for="telefone" class="col-sm-2 tamanho-font al-telefone">Telefone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
                            <div class="col-sm-8">
                        ...
                        <div class="botao-cadastrar b-cadastrar pt-3"><button type="submit" name="cadastrarUsuario" class="btn btn-outline-success" value="Cadastrar">Cadastrar</button></div>
