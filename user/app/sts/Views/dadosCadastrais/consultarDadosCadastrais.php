...
<div class="d-flex">
        ...
        <ul class="list-unstyled">
            ...
            <li>
                ...
                <ul class="list-unstyled collapse" id="submenu2">
                    <li class="active"><a href="<?php echo URL . 'user/consultar-dados-cadastrais/consultar-dados-cadastrais'; ?>"> <i class="fas fa-seedling text-warning"></i> Consultar</a></li>  
    ...
    <section id="" class="p-4 alinhamento"> <!-- Início Seção Visualizar Cadastro -->
        <div class="container">
            <h5 class="estilo-font p-1 text-body" style="letter-spacing: 0.5px;"><i class="fas fa-seedling text-success"></i> <b>CONSULTAR DADOS DO DENUNCIANTE </b></h5>
            <fieldset class="the-fieldset">    
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="p-2" class="form" action="" method="POST"> <!-- Início Formulário Alterar Dados Cadastrais -->
