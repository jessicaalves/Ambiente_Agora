...
<section class="alinhamento">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="<?php echo URL . 'user/assets/img/imagensSistema/img30.png'; ?>" class="img-fluid pt-3 pb-3" alt="Responsive image">
            </div>
                ...
                <div class="align-self-center">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group row mr-6"> 
                            ...
                            <div class="col-sm-8">
                                <input name="senha" type="password" class="form-control tamanho-text c-campo-email-resp" required="required" placeholder="Digite a senha">
                            </div>
