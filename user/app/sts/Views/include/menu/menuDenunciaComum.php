    ...
    <nav class="navbar navbar-expand-sm navbar-dark barra-preta navbar-custom">
        <ul class="navbar-nav">
            <li class="nav-item">
                ...
                <a href="#" class="navbar navbar-brand"><img src="<?php echo URL . 'user/assets/img/imagensSistema/logo3.png'; ?>" width="140" height="40"></a>
            </li>
        </ul>
        <div class="dropdown nav-link ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item bg-transparent" href="<?php echo URL . 'user/login/logout'; ?>"><i class="fas fa-sign-out-alt"></i> Sair</a>
            </div>
        </div>
    </nav>  
</header> <!-- Final Menu -->
