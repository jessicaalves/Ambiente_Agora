<!-- @author jessica -->
<!-- Página de Visualizar Denúncias Realizadas -->  
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <title>Visualizar Avaliação da Denúncia | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL . '/user/assets/css/usuario_visualizar_dados_denuncia.css'; ?>">   
