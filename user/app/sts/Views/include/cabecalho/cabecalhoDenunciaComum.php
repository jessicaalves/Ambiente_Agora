...
<html>
    <head>
        ...
        <title>Nova Denúncia | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL . '/user/assets/css/usuario_denuncia_comum.css'; ?>">
