<!-- @author jessica -->
<!-- Página Visualizar Dados Cadastrais do Usuário -->  
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <title>Visualizar Dados Cadastrais | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" text="text/css" href="<?php echo URL . 'user/assets/css/usuario_visualizar_dados_cadastrais.css'; ?>">
