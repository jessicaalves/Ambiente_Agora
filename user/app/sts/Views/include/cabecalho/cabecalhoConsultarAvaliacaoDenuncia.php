...
<html>
    <head>
        ...
        <title>Consultar Avaliação da Denúncia | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL . '/user/assets/css/usuario_consultar_dados_denuncia.css'; ?>">   
