...
<html>
    <head>
        ...
        <title>Consultar Dados Cadastrais | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" text="text/css" href="<?php echo URL . 'user/assets/css/usuario_consultar_dados_cadastrais.css'; ?>">
