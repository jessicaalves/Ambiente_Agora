                ...
                <div class="col-md-12">
                    ...
                    <form class="p-2" class="form" method="POST" id="formDenunciaAnonima" enctype="multipart/form-data"> <!-- Início Formulário Nova Denúncia Anônima -->
                        ...
                        <div class="form-group row alinhamento c-tipo-resp">
                            ...
                            <div class="col-sm-8">
                                <select class="form-select tamanho-font-tipo" name="tipo" type="select" id="Tipo"
                                        value="<?php
                        ...
                        <div class="form-group row alinhamento c-envolvido-resp">
                            ...
                            <div class="col-sm-8">
                                <select class="form-select tamanho-font-tipo tamanho" name="envolvido" type="select" id="Envolvido"
                                        value="<?php
...
//                                                "<br>Longitude: " + lon;
                        ...
                        <div class="pt-3 botao-denunciar b-denunciar"><button name="cadastrarDenunciaAnonima" type="submit" value="Denunciar" class="btn btn-outline-success alin-de">Denunciar</button></div>
