...
<html>
    <head>
        ...
        <title>Visualizar Denúncia Comum | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" type="text/css" href="<?php echo URLADM . '/assets/css/adm_visualizar_denuncia_comum.css'; ?>">   
