...
<!-- @author jessica -->
<!-- Página Alterar Dados Cadastrais do Usuário -->    
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <title>Alterar Dados Cadastrais | Ambiente Agora</title>
        ...
        <!-- Estilo Customizado -->
        <link rel="stylesheet" type="text/css" href="<?php echo URLADM . '/assets/css/adm_alterar_dados_cadastrais.css'; ?>">
