...
<section id="" class="p-4"> <!-- Início Seção Alterar Cadastro -->
    <div class="container">
        ...
        <h5 class="estilo-font p-1 text-body" style="letter-spacing: 0.5px;"><i class="fas fa-seedling text-success"></i> <b>ALTERAR USUÁRIO</b> </h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="p-2 form" method="POST" action=""> <!-- Início Formulário Alterar Dados Cadastrais -->
                        ...
                        <h5 class="p-2 borda-conteudo" id="">Dados de Acesso - Alterar Usuário</h5><p><p>
