...
<!--                        <div class="form-group row alinhamento c-nome-resp"> 
                        ...
                        <div class="form-group row alinhamento c-tipo-resp">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control tamanho-font-tipo bg-white tamanho-font" name="adms_nivel_acesso_id" type="select" id="adms_nivel_acesso_id">
                        ...
                        <div class="form-group row alinhamento c-tipo-resp">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control tamanho-font-tipo bg-white tamanho-font" name="adms_sit_usuario_id" type="select" id="adms_sit_usuario_id">
                        ...
                        <div class="botao-atualizar b-atualizar pt-3"><button class="btn btn-success btn-sm" type="submit" name="atualizarUsuario" value="atualizarUsuario">Alterar</button></div> 
                        <?php
                        //if ($this->dados['botao']['visUsuario']) {
                            ?>
<!--                            <div class="botao-visualizar">
                                <a href="<?php echo URLADM . 'visualizarUsuario/visualizar-usuario/' . $valorForm['id']; ?>" style="float:center; vertical-align:middle;" class="btn btn-primary btn-sm">Visualizar</a>
                            </div>-->
                            <?php
                        //}
                        ?>
