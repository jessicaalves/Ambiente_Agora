...
<!--                            <div class="botao-visualizar">
                                <a href="<?php echo URLADM . 'visualizar-denuncia-comum/visualizar-denuncia-comum/' . $valorForm['id']; ?>" style="float:center; vertical-align:middle;" class="btn btn-primary btn-sm">Visualizar</a>
                            </div>-->
                            <?php
                        //}
                        ?>
