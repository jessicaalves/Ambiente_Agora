...
<section id="" class="p-4"> <!-- Início Seção Denúncias Realizadas -->  
    <div class="container">
        ...
        //if ($this->dados['botao']['listDenuncias']) {
            ?>
<!--            <a href="<?php echo URLADM . 'listar-denuncias/listar-denuncias'; ?>">
                <div class="p-2">
        ...
        <h5 class="estilo-font p-1 text-body" style="letter-spacing: 0.5px;"><i class="fas fa-seedling text-success"></i> <b>AVALIAR DENÚNCIA</b></h5>
                ...
                <div class="col-md-12">
                    ...
                    <form class="p-2 form" method="POST" action=""> <!-- Início Formulário Alterar Dados Cadastrais -->
                        <input name="id" type="hidden" value="<?php
                            ...
                            ?>">
                        <h5 class="p-2 borda-conteudo" id="">Dados - Avaliar Denúncia</h5><p><p>
...
<!--                            <div class="botao-visualizar">
                                <a href="<?php echo URLADM . 'visualizar-denuncia/visualizar-denuncia/' . $valorForm['id']; ?>" style="float:center; vertical-align:middle;" class="btn btn-primary btn-sm">Visualizar</a>
                            </div>-->
                            <?php
                        //}
                        ?>
