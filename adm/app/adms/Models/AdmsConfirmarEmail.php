...
class AdmsConfirmarEmail {
    ...
    public function confirmarEmail($chave) {
        ...
        $validaChave->fullRead("SELECT id FROM adms_usuarios WHERE confirmar_email =:confirmar_email LIMIT :limit", "confirmar_email={$this->dadosChave}&limit=1");
    ...
    private function updateConfEmail() {
        ...
        $this->dados['adms_sit_usuario_id'] = 1;
